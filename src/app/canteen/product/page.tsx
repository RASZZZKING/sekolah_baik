  ...
  return (
    <div className="bg-base-100 pt-4 pb-24">
      <div className="flex justify-between px-6 items-center">
        ...
        <Heart size={24} weight="bold" className="cursor-pointer" />
      </div>
      <div className="flex-col flex gap-6 mt-4">
        <div className="w-full aspect-square bg-slate-500"></div>
        ...
        <div className="fixed top-0 left-0 w-screen h-screen flex  justify-center items-center">
          <div className="w-72 py-4 rounded-xl flex flex-col gap-3 bg-slate-50">
            ...
            <div className="flex px-4 justify-between items-center">
              <div className="join">
                <button className="join-item btn-xs btn text-slate-500 ">-</button>
                <button className="join-item btn btn-xs text-slate-500 ">1</button>
                <button className="join-item btn-xs btn text-slate-500 ">+</button>
              </div>
              <div className="flex items-center">
                <div className="btn-xs mr-1 btn">
                  <ShoppingCart size={17} className="text-slate-500" />
                </div>
                <div className="btn-xs btn-primary btn">Pay Now</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="fixed bottom-0 bg-base-100 shadow-inner w-full max-w-full px-6 py-4 flex gap-4">
          ...
          <div className="btn flex-1  btn-primary">
            Buy
            {/* <Coins size={20} />  */}
          </div>
        </div>
